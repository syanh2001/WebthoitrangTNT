<main>
    ...
    <a href="<?= CONTROLLERS_ADMIN ?>?action=danhsachdh" class="btn them">Danh sách đơn hàng
    </a>
    ...
    <div class="table-responsive">
        ...
        <tr>
            <td><input onclick="return confirm('Bạn muốn xóa theo lựa chọn ?');" class="btn btn-danger" type="submit" name="delete_user" value="xóa click" id="checkall"></td>
        </tr>
        </form>
    </div>
</main>